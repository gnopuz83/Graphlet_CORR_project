...
GCD_oracle_random = function(True_graph, pulsar_obj, GC_fun, GCF = F, LC=FALSE){
  ...
  if(GCF ==T){
    ...
    if(LC==TRUE){
      GCM1 = gcvec_extended_random3_LC(G1)
    }else{
...
GCD_oracle_random_nothing = function(True_graph, pulsar_obj, GC_fun, GCF = F, LC = F){
  ...
  if(GCF ==T){
    ...
    if(LC==TRUE){
      GCM1 = gcvec_extended_random1_LC(G1)
    }else{
...
Function_GCD_data = function(pulsar_obj, real_G){
  ...
  for(lambda_sub in rev(pulsar_obj$gcd_new$graph_subsambling)){
    ...
    GCM_replace_zeros = gcvec_extended_random_replace_the_zeros(real_G)
    
    
    GCM1_LC = gcvec_extended_random1_LC(real_G)
    GCM_random_LC = gcvec_extended_random2_LC(real_G)
    GCM13_LC = gcvec_extended_random3_LC(real_G)
    GCM_replace_zeros_LC = gcvec_extended_random_replace_the_zeros_LC(real_G)
    ...
    for(graph1 in lambda_sub){
      ...
      GCM_replace_zeros_in_subsampling = gcvec_extended_random_replace_the_zeros(graph1)
      
      GCM2_LC = gcvec_extended_random1_LC(graph1)
      GCM3_LC = gcvec_extended_random2_LC(graph1)
      GCM4_LC = gcvec_extended_random3_LC(graph1)
      GCM_replace_zeros_in_subsampling_LC = gcvec_extended_random_replace_the_zeros_LC(graph1)
      
      dist_gcd1 = GCD(GCM2, GCM1)
      #dist_gcd2 = GCD(GCM2, GCM13)
      dist_gcd2 = GCD(GCM1, GCM3)
      dist_gcd3 = GCD(GCM4, GCM13)
      dist_gcd4 = GCD(GCM3, GCM13)
      dist_gcd5 = GCD(GCM3, GCM_random)
      dist_gcd6 = GCD(GCM_replace_zeros, GCM_replace_zeros_in_subsampling)
      
      
      dist_gcd1_LC = GCD(GCM2_LC, GCM1_LC)
      dist_gcd2_LC = GCD(GCM1_LC, GCM3_LC)
      dist_gcd3_LC = GCD(GCM4_LC, GCM13_LC)
      dist_gcd4_LC = GCD(GCM3_LC, GCM13_LC)
      dist_gcd5_LC = GCD(GCM3_LC, GCM_random_LC)
      dist_gcd6_LC = GCD(GCM_replace_zeros_LC, GCM_replace_zeros_in_subsampling_LC)
      ...
      sub_df6 = c(sub_df6, dist_gcd6)
      
      sub_df1_LC = c(sub_df1_LC, dist_gcd1_LC)
      sub_df2_LC = c(sub_df2_LC, dist_gcd2_LC)
      sub_df3_LC = c(sub_df3_LC, dist_gcd3_LC)
      sub_df4_LC = c(sub_df4_LC, dist_gcd4_LC)
      sub_df5_LC = c(sub_df5_LC, dist_gcd5_LC)
      sub_df6_LC = c(sub_df6_LC, dist_gcd6_LC)
    ...
    mean_gcd6 = c(mean_gcd6, mean(sub_df6))
    
    mean_gcd1_LC = c(mean_gcd1_LC, mean(sub_df1_LC))
    mean_gcd2_LC = c(mean_gcd2_LC, mean(sub_df2_LC))
    mean_gcd3_LC = c(mean_gcd3_LC, mean(sub_df3_LC))
    mean_gcd4_LC = c(mean_gcd4_LC, mean(sub_df4_LC))
    mean_gcd5_LC = c(mean_gcd5_LC, mean(sub_df5_LC))
    mean_gcd6_LC = c(mean_gcd6_LC, mean(sub_df6_LC))
  ...
  tot_df1$mean_gcd6 = mean_gcd6
  
  tot_df1$mean_gcd1_LC = mean_gcd1_LC
  tot_df1$mean_gcd2_LC = mean_gcd2_LC
  tot_df1$mean_gcd3_LC = mean_gcd3_LC
  tot_df1$mean_gcd4_LC = mean_gcd4_LC
  tot_df1$mean_gcd5_LC = mean_gcd5_LC
  tot_df1$mean_gcd6_LC = mean_gcd6_LC
...
gcvec_extended_random1_LC = function(G, orbind=c(0, 2, 5, 7, 8, 10, 11, 6, 9, 4, 1)+1, five = FALSE){
  ...
  matrix = rbind(gcount[,orbind],1) 
  gcor <- suppressWarnings(latentcor(matrix))
  R1 = gcor$R
  return(R1[upper.tri(R1)])
}
...
gcvec_extended_random3_LC = function(G, orbind=c(0, 2, 5, 7, 8, 10, 11, 6, 9, 4, 1)+1, five = FALSE){
...
gcvec_extended_random2_LC = function(G, orbind=c(0, 2, 5, 7, 8, 10, 11, 6, 9, 4, 1)+1, five = FALSE){
  ...
  gcor <- suppressWarnings(latentcor(add_1_minus1))
  return(gcor$R[upper.tri(gcor$R)])
  }




gcvec_extended_random_replace_the_zeros = function(G, orbind=c(0, 2, 5, 7, 8, 10, 11, 6, 9, 4, 1)+1, five = FALSE){
  ...
  for (i in colnames(gcount)) {
    for (j in 1:dim(gcount)[1]){
      if(sum(gcount[j,i])==0){
        gcount[j,i] = runif(1, 0.0001, 0.0002)
      }
...
gcvec_extended_random_replace_the_zeros_LC = function(G, orbind=c(0, 2, 5, 7, 8, 10, 11, 6, 9, 4, 1)+1, five = FALSE){
...
GCD_Oracle_results_strategy6 = list()

GCD_Oracle_results_strategy1_LC = list()
GCD_Oracle_results_strategy2_LC = list()
GCD_Oracle_results_strategy3_LC = list()
GCD_Oracle_results_strategy4_LC = list()
GCD_Oracle_results_strategy5_LC = list()
GCD_Oracle_results_strategy6_LC = list()
...
GCD_GIP_results_strategy6 = list()

GCD_GIP_results_strategy1_LC = list()
GCD_GIP_results_strategy2_LC = list()
GCD_GIP_results_strategy3_LC = list()
GCD_GIP_results_strategy4_LC = list()
GCD_GIP_results_strategy5_LC = list()
GCD_GIP_results_strategy6_LC = list()
...
GCD_GIP_res_strategy6 = list()

GCD_GIP_res_strategy1_LC = list()
GCD_GIP_res_strategy2_LC = list()
GCD_GIP_res_strategy3_LC = list()
GCD_GIP_res_strategy4_LC = list()
GCD_GIP_res_strategy5_LC = list()
GCD_GIP_res_strategy6_LC = list()
...
GCD_Oracle_res_strategy6 = list()


GCD_Oracle_res_strategy1_LC = list()
GCD_Oracle_res_strategy2_LC = list()
GCD_Oracle_res_strategy3_LC = list()
GCD_Oracle_res_strategy4_LC = list()
GCD_Oracle_res_strategy5_LC = list()
GCD_Oracle_res_strategy6_LC = list()
...
for(i in 2:11){
  ...
  GCD_Oracle_400_HUB_scheme_random_noise_both = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random2, GCF = T)
  ...
  GCD_Oracle_400_HUB_scheme_replace_zeros = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random_replace_the_zeros, GCF = T)
  
  
  
  GCD_Oracle_400_HUB_scheme_nothing_LC = GCD_oracle_random_nothing(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random1_LC, LC=TRUE)
  
  GCD_Oracle_400_HUB_scheme_random_noise_LC = GCD_oracle_random_nothing(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random2_LC, LC=TRUE)
  
  GCD_Oracle_400_HUB_scheme_random_noise_both_LC = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random2_LC, GCF = T)
  
  GCD_Oracle_400_HUB_scheme_random_vector_LC = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random3_LC,LC=TRUE)
  
  GCD_Oracle_400_HUB_scheme_both_LC = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random2_LC, LC=TRUE)
  
  GCD_Oracle_400_HUB_scheme_replace_zeros_LC = GCD_oracle_random(Data1_HUB$real_graph, pulsar_gip_400_HUB_gl,gcvec_extended_random_replace_the_zeros_LC, GCF = T)
  ...
  GCD_Oracle_results_strategy5 = append(GCD_Oracle_results_strategy5, list(GCD_Oracle_400_HUB_scheme_random_noise_both))
  GCD_Oracle_results_strategy6 = append(GCD_Oracle_results_strategy6, list(GCD_Oracle_400_HUB_scheme_replace_zeros))
  
  GCD_Oracle_results_strategy1_LC = append(GCD_Oracle_results_strategy1_LC, list(GCD_Oracle_400_HUB_scheme_nothing_LC))
  GCD_Oracle_results_strategy2_LC = append(GCD_Oracle_results_strategy2_LC, list(GCD_Oracle_400_HUB_scheme_random_noise_LC))
  GCD_Oracle_results_strategy3_LC = append(GCD_Oracle_results_strategy3_LC, list(GCD_Oracle_400_HUB_scheme_random_vector_LC))
  GCD_Oracle_results_strategy4_LC = append(GCD_Oracle_results_strategy4_LC, list(GCD_Oracle_400_HUB_scheme_both_LC))
  GCD_Oracle_results_strategy5_LC = append(GCD_Oracle_results_strategy5_LC, list(GCD_Oracle_400_HUB_scheme_random_noise_both_LC))
  GCD_Oracle_results_strategy6_LC = append(GCD_Oracle_results_strategy6_LC, list(GCD_Oracle_400_HUB_scheme_replace_zeros_LC))
  ...
  GCD_Oracle_res_strategy5 = append(GCD_Oracle_res_strategy5, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_random_noise_both)]))
  GCD_Oracle_res_strategy6 = append(GCD_Oracle_res_strategy6, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_replace_zeros)]))
  
  GCD_Oracle_res_strategy1_LC = append(GCD_Oracle_res_strategy1_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_nothing_LC)]))
  GCD_Oracle_res_strategy2_LC = append(GCD_Oracle_res_strategy2_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_random_noise_LC)]))
  GCD_Oracle_res_strategy3_LC = append(GCD_Oracle_res_strategy3_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_random_vector_LC)]))
  GCD_Oracle_res_strategy4_LC = append(GCD_Oracle_res_strategy4_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_both_LC)]))
  GCD_Oracle_res_strategy5_LC = append(GCD_Oracle_res_strategy5_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_random_noise_both_LC)]))
  GCD_Oracle_res_strategy6_LC = append(GCD_Oracle_res_strategy6_LC, list(HD_Hub_400[which.min(GCD_Oracle_400_HUB_scheme_replace_zeros_LC)]))
  ...
  GCD_GIP_results_strategy6 = append(GCD_GIP_results_strategy6, list(GCD_gip_hub_400_gl$mean_gcd6))
  
  
  GCD_GIP_results_strategy1_LC = append(GCD_GIP_results_strategy1_LC, list(GCD_gip_hub_400_gl$mean_gcd1_LC))
  GCD_GIP_results_strategy2_LC = append(GCD_GIP_results_strategy2_LC, list(GCD_gip_hub_400_gl$mean_gcd2_LC))
  GCD_GIP_results_strategy3_LC = append(GCD_GIP_results_strategy3_LC, list(GCD_gip_hub_400_gl$mean_gcd3_LC))
  GCD_GIP_results_strategy4_LC = append(GCD_GIP_results_strategy4_LC, list(GCD_gip_hub_400_gl$mean_gcd4_LC))
  GCD_GIP_results_strategy5_LC = append(GCD_GIP_results_strategy5_LC, list(GCD_gip_hub_400_gl$mean_gcd5_LC))
  GCD_GIP_results_strategy6_LC = append(GCD_GIP_results_strategy6_LC, list(GCD_gip_hub_400_gl$mean_gcd6_LC))
  ...
  GCD_GIP_res_strategy6 = append(GCD_GIP_res_strategy6, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd6)]))
  
  GCD_GIP_res_strategy1_LC = append(GCD_GIP_res_strategy1_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd1_LC)]))
  GCD_GIP_res_strategy2_LC = append(GCD_GIP_res_strategy2_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd2_LC)]))
  GCD_GIP_res_strategy3_LC = append(GCD_GIP_res_strategy3_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd3_LC)]))
  GCD_GIP_res_strategy4_LC = append(GCD_GIP_res_strategy4_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd4_LC)]))
  GCD_GIP_res_strategy5_LC = append(GCD_GIP_res_strategy5_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd5_LC)]))
  GCD_GIP_res_strategy6_LC = append(GCD_GIP_res_strategy6_LC, list(HD_Hub_400[which.min(GCD_gip_hub_400_gl$mean_gcd6_LC)]))
...
vector_GCD_GIP_res_strategy6 = c()


vector_GCD_GIP_res_strategy1_LC = c()
vector_GCD_GIP_res_strategy2_LC = c()
vector_GCD_GIP_res_strategy3_LC = c()
vector_GCD_GIP_res_strategy4_LC = c()
vector_GCD_GIP_res_strategy5_LC = c()
vector_GCD_GIP_res_strategy6_LC = c()
...
for(i in GCD_GIP_res_strategy6){
  vector_GCD_GIP_res_strategy6 = c(vector_GCD_GIP_res_strategy6,i)
}



for(i in GCD_GIP_res_strategy1_LC){
  vector_GCD_GIP_res_strategy1_LC = c(vector_GCD_GIP_res_strategy1_LC,i)
}

for(i in GCD_GIP_res_strategy2_LC){
  vector_GCD_GIP_res_strategy2_LC = c(vector_GCD_GIP_res_strategy2_LC,i)
}

for(i in GCD_GIP_res_strategy3_LC){
  vector_GCD_GIP_res_strategy3_LC = c(vector_GCD_GIP_res_strategy3_LC,i)
}

for(i in GCD_GIP_res_strategy4_LC){
  vector_GCD_GIP_res_strategy4_LC = c(vector_GCD_GIP_res_strategy4_LC,i)
}

for(i in GCD_GIP_res_strategy5_LC){
  vector_GCD_GIP_res_strategy5_LC = c(vector_GCD_GIP_res_strategy5_LC,i)
}

for(i in GCD_GIP_res_strategy6_LC){
  vector_GCD_GIP_res_strategy6_LC = c(vector_GCD_GIP_res_strategy6_LC,i)
}
...
vector_GCD_Oracle_res_strategy6 = c()


vector_GCD_Oracle_res_strategy1_LC = c()
vector_GCD_Oracle_res_strategy2_LC = c()
vector_GCD_Oracle_res_strategy3_LC = c()
vector_GCD_Oracle_res_strategy4_LC = c()
vector_GCD_Oracle_res_strategy5_LC = c()
vector_GCD_Oracle_res_strategy6_LC = c()
...
for(i in GCD_Oracle_res_strategy6){
  vector_GCD_Oracle_res_strategy6 = c(vector_GCD_Oracle_res_strategy6,i)
}



for(i in GCD_Oracle_res_strategy1_LC){
  vector_GCD_Oracle_res_strategy1_LC = c(vector_GCD_Oracle_res_strategy1_LC,i)
}

for(i in GCD_Oracle_res_strategy2_LC){
  vector_GCD_Oracle_res_strategy2_LC = c(vector_GCD_Oracle_res_strategy2_LC,i)
}

for(i in GCD_Oracle_res_strategy3_LC){
  vector_GCD_Oracle_res_strategy3_LC = c(vector_GCD_Oracle_res_strategy3_LC,i)
}

for(i in GCD_Oracle_res_strategy4_LC){
  vector_GCD_Oracle_res_strategy4_LC = c(vector_GCD_Oracle_res_strategy4_LC,i)
}

for(i in GCD_Oracle_res_strategy5_LC){
  vector_GCD_Oracle_res_strategy5_LC = c(vector_GCD_Oracle_res_strategy5_LC,i)
}

for(i in GCD_Oracle_res_strategy6_LC){
  vector_GCD_Oracle_res_strategy6_LC = c(vector_GCD_Oracle_res_strategy6_LC,i)
}
...
res_tot_hub = cbind(vector_GCD_GIP_res_strategy1, vector_GCD_GIP_res_strategy2, vector_GCD_GIP_res_strategy3, vector_GCD_GIP_res_strategy4,vector_GCD_GIP_res_strategy5, vector_GCD_GIP_res_strategy6,
                       vector_GCD_Oracle_res_strategy1, vector_GCD_Oracle_res_strategy2, vector_GCD_Oracle_res_strategy3, vector_GCD_Oracle_res_strategy4,vector_GCD_Oracle_res_strategy5, vector_GCD_Oracle_res_strategy6,
                    vector_GCD_GIP_res_strategy1_LC, vector_GCD_GIP_res_strategy2_LC, vector_GCD_GIP_res_strategy3_LC, vector_GCD_GIP_res_strategy4_LC,vector_GCD_GIP_res_strategy5_LC, vector_GCD_GIP_res_strategy6_LC,
                    vector_GCD_Oracle_res_strategy1_LC, vector_GCD_Oracle_res_strategy2_LC, vector_GCD_Oracle_res_strategy3_LC, vector_GCD_Oracle_res_strategy4_LC,vector_GCD_Oracle_res_strategy5_LC, vector_GCD_Oracle_res_strategy6_LC,
...
H_res_GCD_Oracle_S6 = c()
for(i in GCD_Oracle_results_strategy6){
  H_res_GCD_Oracle_S6 = cbind(H_res_GCD_Oracle_S6, i)
}

H_res_GCD_Oracle_S6_df = as.data.frame(H_res_GCD_Oracle_S6)
colnames(H_res_GCD_Oracle_S6_df) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")



H_res_GCD_Oracle_S1_LC = c()
for(i in GCD_Oracle_results_strategy1_LC){
  H_res_GCD_Oracle_S1_LC = cbind(H_res_GCD_Oracle_S1_LC, i)
}

H_res_GCD_Oracle_S1_df_LC = as.data.frame(H_res_GCD_Oracle_S1_LC)
colnames(H_res_GCD_Oracle_S1_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_Oracle_S2_LC = c()
for(i in GCD_Oracle_results_strategy2_LC){
  H_res_GCD_Oracle_S2_LC = cbind(H_res_GCD_Oracle_S2_LC, i)
}

H_res_GCD_Oracle_S2_df_LC = as.data.frame(H_res_GCD_Oracle_S2_LC)
colnames(H_res_GCD_Oracle_S2_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_Oracle_S3_LC = c()
for(i in GCD_Oracle_results_strategy3_LC){
  H_res_GCD_Oracle_S3_LC = cbind(H_res_GCD_Oracle_S3_LC, i)
}

H_res_GCD_Oracle_S3_df_LC = as.data.frame(H_res_GCD_Oracle_S3_LC)
colnames(H_res_GCD_Oracle_S3_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_Oracle_S4_LC = c()
for(i in GCD_Oracle_results_strategy4_LC){
  H_res_GCD_Oracle_S4_LC = cbind(H_res_GCD_Oracle_S4_LC, i)
}

H_res_GCD_Oracle_S4_df_LC = as.data.frame(H_res_GCD_Oracle_S4_LC)
colnames(H_res_GCD_Oracle_S4_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_Oracle_S5_LC = c()
for(i in GCD_Oracle_results_strategy5_LC){
  H_res_GCD_Oracle_S5_LC = cbind(H_res_GCD_Oracle_S5_LC, i)
}

H_res_GCD_Oracle_S5_df_LC = as.data.frame(H_res_GCD_Oracle_S5_LC)
colnames(H_res_GCD_Oracle_S5_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_Oracle_S6_LC = c()
for(i in GCD_Oracle_results_strategy6_LC){
  H_res_GCD_Oracle_S6_LC = cbind(H_res_GCD_Oracle_S6_LC, i)
}

H_res_GCD_Oracle_S6_df_LC = as.data.frame(H_res_GCD_Oracle_S6_LC)
colnames(H_res_GCD_Oracle_S6_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")
...
H_res_GCD_GIP_S6 = c()
for(i in GCD_GIP_results_strategy6){
  H_res_GCD_GIP_S6 = cbind(H_res_GCD_GIP_S6, i)
}
...
H_res_GCD_GIP_S1_LC = c()
for(i in GCD_GIP_results_strategy1_LC){
  H_res_GCD_GIP_S1_LC = cbind(H_res_GCD_GIP_S1_LC, i)
}

H_res_GCD_GIP_S1_df_LC = as.data.frame(H_res_GCD_GIP_S1_LC)
colnames(H_res_GCD_GIP_S1_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_GIP_S2_LC = c()
for(i in GCD_GIP_results_strategy2_LC){
  H_res_GCD_GIP_S2_LC = cbind(H_res_GCD_GIP_S2_LC, i)
}

H_res_GCD_GIP_S2_df_LC = as.data.frame(H_res_GCD_GIP_S2_LC)
colnames(H_res_GCD_GIP_S2_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")



H_res_GCD_GIP_S3_LC = c()
for(i in GCD_GIP_results_strategy3_LC){
  H_res_GCD_GIP_S3_LC = cbind(H_res_GCD_GIP_S3_LC, i)
}

H_res_GCD_GIP_S3_df_LC = as.data.frame(H_res_GCD_GIP_S3_LC)
colnames(H_res_GCD_GIP_S3_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_GIP_S4_LC = c()
for(i in GCD_GIP_results_strategy4_LC){
  H_res_GCD_GIP_S4_LC = cbind(H_res_GCD_GIP_S4_LC, i)
}

H_res_GCD_GIP_S4_df_LC = as.data.frame(H_res_GCD_GIP_S4_LC)
colnames(H_res_GCD_GIP_S4_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


H_res_GCD_GIP_S5_LC = c()
for(i in GCD_GIP_results_strategy5_LC){
  H_res_GCD_GIP_S5_LC = cbind(H_res_GCD_GIP_S5_LC, i)
}

H_res_GCD_GIP_S5_df_LC = as.data.frame(H_res_GCD_GIP_S5_LC)
colnames(H_res_GCD_GIP_S5_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")

H_res_GCD_GIP_S6_LC = c()
for(i in GCD_GIP_results_strategy6_LC){
...
write.csv(H_res_GCD_Oracle_S6_df, "simulations_GCD_Oracle_S6_HUB.csv")

write.csv(H_res_GCD_Oracle_S1_df_LC, "simulations_GCD_Oracle_S1_HUB_LC.csv")
write.csv(H_res_GCD_Oracle_S2_df_LC, "simulations_GCD_Oracle_S2_HUB_LC.csv")
write.csv(H_res_GCD_Oracle_S3_df_LC, "simulations_GCD_Oracle_S3_HUB_LC.csv")
write.csv(H_res_GCD_Oracle_S4_df_LC, "simulations_GCD_Oracle_S4_HUB_LC.csv")
write.csv(H_res_GCD_Oracle_S5_df_LC, "simulations_GCD_Oracle_S5_HUB_LC.csv")
write.csv(H_res_GCD_Oracle_S6_df_LC, "simulations_GCD_Oracle_S6_HUB_LC.csv")
...
write.csv(H_res_GCD_GIP_S6_df, "simulations_GCD_GIP_S6_HUB.csv")

write.csv(H_res_GCD_GIP_S1_df_LC, "simulations_GCD_GIP_S1_HUB_LC.csv")
write.csv(H_res_GCD_GIP_S2_df_LC, "simulations_GCD_GIP_S2_HUB_LC.csv")
write.csv(H_res_GCD_GIP_S3_df_LC, "simulations_GCD_GIP_S3_HUB_LC.csv")
write.csv(H_res_GCD_GIP_S4_df_LC, "simulations_GCD_GIP_S4_HUB_LC.csv")
write.csv(H_res_GCD_GIP_S5_df_LC, "simulations_GCD_GIP_S5_HUB_LC.csv")
write.csv(H_res_GCD_GIP_S6_df_LC, "simulations_GCD_GIP_S6_HUB_LC.csv")
...
R_GCD_Oracle_results_strategy6 = list()


R_GCD_Oracle_results_strategy1_LC = list()
R_GCD_Oracle_results_strategy2_LC = list()
R_GCD_Oracle_results_strategy3_LC = list()
R_GCD_Oracle_results_strategy4_LC = list()
R_GCD_Oracle_results_strategy5_LC = list()
R_GCD_Oracle_results_strategy6_LC = list()
...
R_GCD_GIP_results_strategy6 = list()

R_GCD_GIP_results_strategy1_LC = list()
R_GCD_GIP_results_strategy2_LC = list()
R_GCD_GIP_results_strategy3_LC = list()
R_GCD_GIP_results_strategy4_LC = list()
R_GCD_GIP_results_strategy5_LC = list()
R_GCD_GIP_results_strategy6_LC = list()
...
R_GCD_GIP_res_strategy6 = list()

R_GCD_GIP_res_strategy1_LC = list()
R_GCD_GIP_res_strategy2_LC = list()
R_GCD_GIP_res_strategy3_LC = list()
R_GCD_GIP_res_strategy4_LC = list()
R_GCD_GIP_res_strategy5_LC = list()
R_GCD_GIP_res_strategy6_LC = list()
...
R_GCD_Oracle_res_strategy6 = list()


R_GCD_Oracle_res_strategy1_LC = list()
R_GCD_Oracle_res_strategy2_LC = list()
R_GCD_Oracle_res_strategy3_LC = list()
R_GCD_Oracle_res_strategy4_LC = list()
R_GCD_Oracle_res_strategy5_LC = list()
R_GCD_Oracle_res_strategy6_LC = list()


for(i in 2:11){
  
  Data1_Random = simulate_random_graph(200, 400, c(-1, -0.09, 0.09, 1), K = 50, seed = i, scale_cov = FALSE)
  ...
  R_GCD_Oracle_400_HUB_scheme_replace_zeros = GCD_oracle_random(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random_replace_the_zeros, GCF = T)
  
  
  
  R_GCD_Oracle_400_Random_scheme_nothing_LC = GCD_oracle_random_nothing(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random1_LC, LC = TRUE)
  
  R_GCD_Oracle_400_Random_scheme_random_noise_LC = GCD_oracle_random_nothing(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random2_LC, LC=TRUE)
  
  R_GCD_Oracle_400_Random_scheme_random_noise_both_LC = GCD_oracle_random(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random2_LC, GCF = T)
  
  R_GCD_Oracle_400_Random_scheme_random_vector_LC = GCD_oracle_random(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random3_LC, LC = T)
  
  R_GCD_Oracle_400_Random_scheme_both_LC = GCD_oracle_random(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random2_LC, LC = T)
  
  R_GCD_Oracle_400_HUB_scheme_replace_zeros_LC = GCD_oracle_random(Data1_Random$real_graph, pulsar_gip_400_Random_gl,gcvec_extended_random_replace_the_zeros_LC, GCF = T)
  #GCD GIP calculation
  ...
  R_GCD_Oracle_results_strategy6 = append(R_GCD_Oracle_results_strategy6, list(R_GCD_Oracle_400_HUB_scheme_replace_zeros))
  
  
  R_GCD_Oracle_results_strategy1_LC = append(R_GCD_Oracle_results_strategy1_LC, list(R_GCD_Oracle_400_Random_scheme_nothing_LC))
  R_GCD_Oracle_results_strategy2_LC = append(R_GCD_Oracle_results_strategy2_LC, list(R_GCD_Oracle_400_Random_scheme_random_noise_LC))
  R_GCD_Oracle_results_strategy3_LC = append(R_GCD_Oracle_results_strategy3_LC, list(R_GCD_Oracle_400_Random_scheme_random_vector_LC))
  R_GCD_Oracle_results_strategy4_LC = append(R_GCD_Oracle_results_strategy4_LC, list(R_GCD_Oracle_400_Random_scheme_both_LC))
  R_GCD_Oracle_results_strategy5_LC = append(R_GCD_Oracle_results_strategy5_LC, list(R_GCD_Oracle_400_Random_scheme_random_noise_both_LC))
  R_GCD_Oracle_results_strategy6_LC = append(R_GCD_Oracle_results_strategy6_LC, list(R_GCD_Oracle_400_HUB_scheme_replace_zeros_LC))
  ...
  R_GCD_Oracle_res_strategy6 = append(R_GCD_Oracle_res_strategy6, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_HUB_scheme_replace_zeros)]))
  
  
  R_GCD_Oracle_res_strategy1_LC = append(R_GCD_Oracle_res_strategy1_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_Random_scheme_nothing_LC)]))
  R_GCD_Oracle_res_strategy2_LC = append(R_GCD_Oracle_res_strategy2_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_Random_scheme_random_noise_LC)]))
  R_GCD_Oracle_res_strategy3_LC = append(R_GCD_Oracle_res_strategy3_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_Random_scheme_random_vector_LC)]))
  R_GCD_Oracle_res_strategy4_LC = append(R_GCD_Oracle_res_strategy4_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_Random_scheme_both_LC)]))
  R_GCD_Oracle_res_strategy5_LC = append(R_GCD_Oracle_res_strategy5_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_Random_scheme_random_noise_both_LC)]))
  R_GCD_Oracle_res_strategy6_LC = append(R_GCD_Oracle_res_strategy6_LC, list(R_HD_Hub_400[which.min(R_GCD_Oracle_400_HUB_scheme_replace_zeros_LC)]))
  #HD res
  ...
  R_GCD_GIP_results_strategy6 = append(R_GCD_GIP_results_strategy6, list(R_GCD_gip_hub_400_gl$mean_gcd6))
  
  
  R_GCD_GIP_results_strategy1_LC = append(R_GCD_GIP_results_strategy1_LC, list(R_GCD_gip_hub_400_gl$mean_gcd1_LC))
  R_GCD_GIP_results_strategy2_LC = append(R_GCD_GIP_results_strategy2_LC, list(R_GCD_gip_hub_400_gl$mean_gcd2_LC))
  R_GCD_GIP_results_strategy3_LC = append(R_GCD_GIP_results_strategy3_LC, list(R_GCD_gip_hub_400_gl$mean_gcd3_LC))
  R_GCD_GIP_results_strategy4_LC = append(R_GCD_GIP_results_strategy4_LC, list(R_GCD_gip_hub_400_gl$mean_gcd4_LC))
  R_GCD_GIP_results_strategy5_LC = append(R_GCD_GIP_results_strategy5_LC, list(R_GCD_gip_hub_400_gl$mean_gcd5_LC))
  R_GCD_GIP_results_strategy6_LC = append(R_GCD_GIP_results_strategy6_LC, list(R_GCD_gip_hub_400_gl$mean_gcd6_LC))
  ...
  R_GCD_GIP_res_strategy6 = append(R_GCD_GIP_res_strategy6, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd6)]))
  
  
  
  R_GCD_GIP_res_strategy1_LC = append(R_GCD_GIP_res_strategy1_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd1_LC)]))
  R_GCD_GIP_res_strategy2_LC = append(R_GCD_GIP_res_strategy2_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd2_LC)]))
  R_GCD_GIP_res_strategy3_LC = append(R_GCD_GIP_res_strategy3_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd3_LC)]))
  R_GCD_GIP_res_strategy4_LC = append(R_GCD_GIP_res_strategy4_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd4_LC)]))
  R_GCD_GIP_res_strategy5_LC = append(R_GCD_GIP_res_strategy5_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd5_LC)]))
  R_GCD_GIP_res_strategy6_LC = append(R_GCD_GIP_res_strategy6_LC, list(R_HD_Hub_400[which.min(R_GCD_gip_hub_400_gl$mean_gcd6_LC)]))
...
vector_R_GCD_GIP_res_strategy6 = c()
...
for(i in R_GCD_GIP_res_strategy6){
  vector_R_GCD_GIP_res_strategy6 = c(vector_R_GCD_GIP_res_strategy6,i)
}




vector_R_GCD_GIP_res_strategy1_LC = c()
vector_R_GCD_GIP_res_strategy2_LC = c()
vector_R_GCD_GIP_res_strategy3_LC = c()
vector_R_GCD_GIP_res_strategy4_LC = c()
vector_R_GCD_GIP_res_strategy5_LC = c()
vector_R_GCD_GIP_res_strategy6_LC = c()


for(i in R_GCD_GIP_res_strategy1_LC){
  vector_R_GCD_GIP_res_strategy1_LC = c(vector_R_GCD_GIP_res_strategy1_LC,i)
}

for(i in R_GCD_GIP_res_strategy2_LC){
  vector_R_GCD_GIP_res_strategy2_LC = c(vector_R_GCD_GIP_res_strategy2_LC,i)
}

for(i in R_GCD_GIP_res_strategy3_LC){
  vector_R_GCD_GIP_res_strategy3_LC = c(vector_R_GCD_GIP_res_strategy3_LC,i)
}

for(i in R_GCD_GIP_res_strategy4_LC){
  vector_R_GCD_GIP_res_strategy4_LC = c(vector_R_GCD_GIP_res_strategy4_LC,i)
}

for(i in R_GCD_GIP_res_strategy5_LC){
  vector_R_GCD_GIP_res_strategy5_LC = c(vector_R_GCD_GIP_res_strategy5_LC,i)
}

for(i in R_GCD_GIP_res_strategy6_LC){
  vector_R_GCD_GIP_res_strategy6_LC = c(vector_R_GCD_GIP_res_strategy6_LC,i)
}
...
vector_R_GCD_Oracle_res_strategy6 = c()
...
for(i in R_GCD_Oracle_res_strategy6){
  vector_R_GCD_Oracle_res_strategy6 = c(vector_R_GCD_Oracle_res_strategy6,i)
}
...
vector_R_GCD_Oracle_res_strategy1_LC = c()
vector_R_GCD_Oracle_res_strategy2_LC = c()
vector_R_GCD_Oracle_res_strategy3_LC = c()
vector_R_GCD_Oracle_res_strategy4_LC = c()
vector_R_GCD_Oracle_res_strategy5_LC = c()
vector_R_GCD_Oracle_res_strategy6_LC = c()


for(i in R_GCD_Oracle_res_strategy1_LC){
  vector_R_GCD_Oracle_res_strategy1_LC = c(vector_R_GCD_Oracle_res_strategy1_LC,i)
}

for(i in R_GCD_Oracle_res_strategy2_LC){
  vector_R_GCD_Oracle_res_strategy2_LC = c(vector_R_GCD_Oracle_res_strategy2_LC,i)
}

for(i in R_GCD_Oracle_res_strategy3_LC){
  vector_R_GCD_Oracle_res_strategy3_LC = c(vector_R_GCD_Oracle_res_strategy3_LC,i)
}

for(i in R_GCD_Oracle_res_strategy4_LC){
  vector_R_GCD_Oracle_res_strategy4_LC = c(vector_R_GCD_Oracle_res_strategy4_LC,i)
}

for(i in R_GCD_Oracle_res_strategy5_LC){
  vector_R_GCD_Oracle_res_strategy5_LC = c(vector_R_GCD_Oracle_res_strategy5_LC,i)
}

for(i in R_GCD_Oracle_res_strategy6_LC){
  vector_R_GCD_Oracle_res_strategy6_LC = c(vector_R_GCD_Oracle_res_strategy6_LC,i)
}
...
res_tot_random = cbind(vector_R_GCD_GIP_res_strategy1, vector_R_GCD_GIP_res_strategy2, vector_R_GCD_GIP_res_strategy3, vector_R_GCD_GIP_res_strategy4,vector_R_GCD_GIP_res_strategy5, vector_R_GCD_GIP_res_strategy6,
                       vector_R_GCD_Oracle_res_strategy1, vector_R_GCD_Oracle_res_strategy2, vector_R_GCD_Oracle_res_strategy3, vector_R_GCD_Oracle_res_strategy4, vector_R_GCD_Oracle_res_strategy5, vector_R_GCD_Oracle_res_strategy6,
                       vector_R_GCD_GIP_res_strategy1_LC, vector_R_GCD_GIP_res_strategy2_LC, vector_R_GCD_GIP_res_strategy3_LC, vector_R_GCD_GIP_res_strategy4_LC,vector_R_GCD_GIP_res_strategy5_LC, vector_R_GCD_GIP_res_strategy6_LC,
                       vector_R_GCD_Oracle_res_strategy1_LC, vector_R_GCD_Oracle_res_strategy2_LC, vector_R_GCD_Oracle_res_strategy3_LC, vector_R_GCD_Oracle_res_strategy4_LC, vector_R_GCD_Oracle_res_strategy5_LC, vector_R_GCD_Oracle_res_strategy6_LC,
...
res_GCD_Oracle_S6 = c()
for(i in R_GCD_Oracle_results_strategy6){
  res_GCD_Oracle_S6 = cbind(res_GCD_Oracle_S6, i)
}

res_GCD_Oracle_S6_df = as.data.frame(res_GCD_Oracle_S6)
colnames(res_GCD_Oracle_S6_df) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")



res_GCD_Oracle_S1_LC = c()
for(i in R_GCD_Oracle_results_strategy1_LC){
  res_GCD_Oracle_S1_LC = cbind(res_GCD_Oracle_S1_LC, i)
}

res_GCD_Oracle_S1_df_LC = as.data.frame(res_GCD_Oracle_S1_LC)
colnames(res_GCD_Oracle_S1_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_Oracle_S2_LC = c()
for(i in R_GCD_Oracle_results_strategy2_LC){
  res_GCD_Oracle_S2_LC = cbind(res_GCD_Oracle_S2_LC, i)
}

res_GCD_Oracle_S2_df_LC = as.data.frame(res_GCD_Oracle_S2_LC)
colnames(res_GCD_Oracle_S2_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_Oracle_S3_LC = c()
for(i in R_GCD_Oracle_results_strategy3_LC){
  res_GCD_Oracle_S3_LC = cbind(res_GCD_Oracle_S3_LC, i)
}

res_GCD_Oracle_S3_df_LC = as.data.frame(res_GCD_Oracle_S3_LC)
colnames(res_GCD_Oracle_S3_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_Oracle_S4_LC = c()
for(i in R_GCD_Oracle_results_strategy4_LC){
  res_GCD_Oracle_S4_LC = cbind(res_GCD_Oracle_S4_LC, i)
}

res_GCD_Oracle_S4_df_LC = as.data.frame(res_GCD_Oracle_S4_LC)
colnames(res_GCD_Oracle_S4_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_Oracle_S5_LC = c()
for(i in R_GCD_Oracle_results_strategy5_LC){
  res_GCD_Oracle_S5_LC = cbind(res_GCD_Oracle_S5_LC, i)
}

res_GCD_Oracle_S5_df_LC = as.data.frame(res_GCD_Oracle_S5_LC)
colnames(res_GCD_Oracle_S5_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_Oracle_S6_LC = c()
for(i in R_GCD_Oracle_results_strategy6_LC){
  res_GCD_Oracle_S6_LC = cbind(res_GCD_Oracle_S6_LC, i)
}

res_GCD_Oracle_S6_df_LC = as.data.frame(res_GCD_Oracle_S6_LC)
colnames(res_GCD_Oracle_S6_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")
...
res_GCD_GIP_S6 = c()
for(i in R_GCD_GIP_results_strategy6){
  res_GCD_GIP_S6 = cbind(res_GCD_GIP_S6, i)
}

res_GCD_GIP_S6_df = as.data.frame(res_GCD_GIP_S6)
colnames(res_GCD_GIP_S6_df) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")
...
res_GCD_GIP_S1_LC = c()
for(i in R_GCD_GIP_results_strategy1_LC){
  res_GCD_GIP_S1_LC = cbind(res_GCD_GIP_S1_LC, i)
}

res_GCD_GIP_S1_df_LC = as.data.frame(res_GCD_GIP_S1_LC)
colnames(res_GCD_GIP_S1_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_GIP_S2_LC = c()
for(i in R_GCD_GIP_results_strategy2_LC){
  res_GCD_GIP_S2_LC = cbind(res_GCD_GIP_S2_LC, i)
}

res_GCD_GIP_S2_df_LC = as.data.frame(res_GCD_GIP_S2_LC)
colnames(res_GCD_GIP_S2_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")



res_GCD_GIP_S3_LC = c()
for(i in R_GCD_GIP_results_strategy3_LC){
  res_GCD_GIP_S3_LC = cbind(res_GCD_GIP_S3_LC, i)
}

res_GCD_GIP_S3_df_LC = as.data.frame(res_GCD_GIP_S3_LC)
colnames(res_GCD_GIP_S3_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")


res_GCD_GIP_S4_LC = c()
for(i in R_GCD_GIP_results_strategy4_LC){
  res_GCD_GIP_S4_LC = cbind(res_GCD_GIP_S4_LC, i)
}

res_GCD_GIP_S4_df_LC = as.data.frame(res_GCD_GIP_S4_LC)
colnames(res_GCD_GIP_S4_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")

res_GCD_GIP_S5_LC = c()
for(i in R_GCD_GIP_results_strategy5_LC){
  res_GCD_GIP_S5_LC = cbind(res_GCD_GIP_S5_LC, i)
}

res_GCD_GIP_S5_df_LC = as.data.frame(res_GCD_GIP_S5_LC)
colnames(res_GCD_GIP_S5_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")

res_GCD_GIP_S6_LC = c()
for(i in R_GCD_GIP_results_strategy6_LC){
  res_GCD_GIP_S6_LC = cbind(res_GCD_GIP_S6_LC, i)
}

res_GCD_GIP_S6_df_LC = as.data.frame(res_GCD_GIP_S6_LC)
colnames(res_GCD_GIP_S6_df_LC) = c("sim1", "sim2", "sim3", "sim4", "sim5","sim6", "sim7", "sim8", "sim9", "sim10")
...
write.csv(res_GCD_Oracle_S6_df, "simulations_GCD_Oracle_S6_random.csv")


write.csv(res_GCD_Oracle_S1_df_LC, "simulations_GCD_Oracle_S1_random_LC.csv")
write.csv(res_GCD_Oracle_S2_df_LC, "simulations_GCD_Oracle_S2_random_LC.csv")
write.csv(res_GCD_Oracle_S3_df_LC, "simulations_GCD_Oracle_S3_random_LC.csv")
write.csv(res_GCD_Oracle_S4_df_LC, "simulations_GCD_Oracle_S4_random_LC.csv")
write.csv(res_GCD_Oracle_S5_df_LC, "simulations_GCD_Oracle_S5_random_LC.csv")
write.csv(res_GCD_Oracle_S6_df_LC, "simulations_GCD_Oracle_S6_random_LC.csv")
...
write.csv(res_GCD_GIP_S6_df, "simulations_GCD_GIP_S6_random.csv")


write.csv(res_GCD_GIP_S1_df_LC, "simulations_GCD_GIP_S1_random_LC.csv")
write.csv(res_GCD_GIP_S2_df_LC, "simulations_GCD_GIP_S2_random_LC.csv")
write.csv(res_GCD_GIP_S3_df_LC, "simulations_GCD_GIP_S3_random_LC.csv")
write.csv(res_GCD_GIP_S4_df_LC, "simulations_GCD_GIP_S4_random_LC.csv")
write.csv(res_GCD_GIP_S5_df_LC, "simulations_GCD_GIP_S5_random_LC.csv")
write.csv(res_GCD_GIP_S6_df_LC, "simulations_GCD_GIP_S6_random_LC.csv")
